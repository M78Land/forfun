...
#cmt_local_tagfile = $(BbEmcAlg_tag).make
cmt_local_tagfile = $(bin)$(BbEmcAlg_tag).make
...
cmt_local_setup_BbEmcAlg = $(bin)setup_BbEmcAlg$$$$.make
...
BbEmcAlg_extratags = -tag_add=target_BbEmcAlg

#$(cmt_local_tagfile_BbEmcAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_BbEmcAlg) ::
else
$(cmt_local_tagfile_BbEmcAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_BbEmcAlg); then /bin/rm -f $(cmt_local_tagfile_BbEmcAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(BbEmcAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_BbEmcAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_BbEmcAlg)"; \
	  test ! -f $(cmt_local_setup_BbEmcAlg) || \rm -f $(cmt_local_setup_BbEmcAlg); \
	  trap '\rm -f $(cmt_local_setup_BbEmcAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(BbEmcAlg_extratags) show setup >$(cmt_local_setup_BbEmcAlg) && \
	  if [ -f $(cmt_final_setup_BbEmcAlg) ] && \
	    \cmp -s $(cmt_final_setup_BbEmcAlg) $(cmt_local_setup_BbEmcAlg); then \
	    \rm $(cmt_local_setup_BbEmcAlg); else \
	    \mv -f $(cmt_local_setup_BbEmcAlg) $(cmt_final_setup_BbEmcAlg); fi
...
not_BbEmcAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(BbEmcAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
BbEmcAlgdirs :
	@if test ! -d $(bin)BbEmcAlg; then $(mkdir) -p $(bin)BbEmcAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)BbEmcAlg
else
BbEmcAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)BbEmcAlg
#
#$(cmt_local_BbEmcAlg_makefile) :: $(BbEmcAlg_dependencies) $(cmt_local_tagfile_BbEmcAlg) build_library_links dirs BbEmcAlgdirs
#else
#$(cmt_local_BbEmcAlg_makefile) :: $(BbEmcAlg_dependencies) $(cmt_local_tagfile_BbEmcAlg) build_library_links dirs
#endif
#else
#$(cmt_local_BbEmcAlg_makefile) :: $(cmt_local_tagfile_BbEmcAlg)
#endif

ifdef cmt_BbEmcAlg_has_target_tag

ifndef QUICK
$(cmt_local_BbEmcAlg_makefile) : $(BbEmcAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building BbEmcAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(BbEmcAlg_extratags) build constituent_config -out=$(cmt_local_BbEmcAlg_makefile) BbEmcAlg
else
$(cmt_local_BbEmcAlg_makefile) : $(BbEmcAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_BbEmcAlg) ] || \
	  [ ! -f $(cmt_final_setup_BbEmcAlg) ] || \
	  $(not_BbEmcAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building BbEmcAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(BbEmcAlg_extratags) build constituent_config -out=$(cmt_local_BbEmcAlg_makefile) BbEmcAlg; \
	  fi
endif
...
$(cmt_local_BbEmcAlg_makefile) : $(BbEmcAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building BbEmcAlg.make"; \
	  $(cmtexe) -f=$(bin)BbEmcAlg.in -tag=$(tags) $(BbEmcAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_BbEmcAlg_makefile) BbEmcAlg
else
$(cmt_local_BbEmcAlg_makefile) : $(BbEmcAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)BbEmcAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_BbEmcAlg) ] || \
	  [ ! -f $(cmt_final_setup_BbEmcAlg) ] || \
	  $(not_BbEmcAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(BbEmcAlg_extratags) build constituent_makefile -out=$(cmt_local_BbEmcAlg_makefile) BbEmcAlg

BbEmcAlg :: $(BbEmcAlg_dependencies) $(cmt_local_BbEmcAlg_makefile) dirs BbEmcAlgdirs
	$(echo) "(constituents.make) Starting BbEmcAlg"
	@if test -f $(cmt_local_BbEmcAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_BbEmcAlg_makefile) BbEmcAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_BbEmcAlg_makefile) BbEmcAlg
	$(echo) "(constituents.make) BbEmcAlg done"

clean :: BbEmcAlgclean

BbEmcAlgclean :: $(BbEmcAlgclean_dependencies) ##$(cmt_local_BbEmcAlg_makefile)
	$(echo) "(constituents.make) Starting BbEmcAlgclean"
	@-if test -f $(cmt_local_BbEmcAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_BbEmcAlg_makefile) BbEmcAlgclean; \
	fi
	$(echo) "(constituents.make) BbEmcAlgclean done"
#	@-$(MAKE) -f $(cmt_local_BbEmcAlg_makefile) BbEmcAlgclean

##	  /bin/rm -f $(cmt_local_BbEmcAlg_makefile) $(bin)BbEmcAlg_dependencies.make

install :: BbEmcAlginstall

BbEmcAlginstall :: $(BbEmcAlg_dependencies) $(cmt_local_BbEmcAlg_makefile)
	$(echo) "(constituents.make) Starting install BbEmcAlg"
	@-$(MAKE) -f $(cmt_local_BbEmcAlg_makefile) install
	$(echo) "(constituents.make) install BbEmcAlg done"

uninstall : BbEmcAlguninstall

$(foreach d,$(BbEmcAlg_dependencies),$(eval $(d)uninstall_dependencies += BbEmcAlguninstall))

BbEmcAlguninstall : $(BbEmcAlguninstall_dependencies) ##$(cmt_local_BbEmcAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall BbEmcAlg"
	@if test -f $(cmt_local_BbEmcAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_BbEmcAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_BbEmcAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall BbEmcAlg done"

remove_library_links :: BbEmcAlguninstall
...
#cmt_local_tagfile_config = $(BbEmcAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(BbEmcAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)BbEmcAlg_configsetup.make
...
#cmt_local_tagfile_config = $(BbEmcAlg_tag).make
cmt_local_tagfile_config = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)BbEmcAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(BbEmcAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(BbEmcAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)BbEmcAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(BbEmcAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)BbEmcAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(BbEmcAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(BbEmcAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)BbEmcAlg_makesetup.make
...
#cmt_local_tagfile_make = $(BbEmcAlg_tag).make
cmt_local_tagfile_make = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)BbEmcAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(BbEmcAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(BbEmcAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)BbEmcAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(BbEmcAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)BbEmcAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(BbEmcAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(BbEmcAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)BbEmcAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(BbEmcAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)BbEmcAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(BbEmcAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(BbEmcAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)BbEmcAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(BbEmcAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)BbEmcAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(BbEmcAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(BbEmcAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)BbEmcAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(BbEmcAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)BbEmcAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(BbEmcAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(BbEmcAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)BbEmcAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(BbEmcAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)BbEmcAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(BbEmcAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(BbEmcAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)BbEmcAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(BbEmcAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)BbEmcAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(BbEmcAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(BbEmcAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)BbEmcAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(BbEmcAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(BbEmcAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)BbEmcAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
