...
#  Library VertexFit
#
#   Generated Thu Nov 11 07:57:20 2021  by bes3pub
#
#====================================
...
$(VertexFitlib) :: $(bin)BField.o $(bin)FastVertexFit.o $(bin)GammaShape.o $(bin)HTrackParameter.o $(bin)Helix.o $(bin)KalmanKinematicFit.o $(bin)KalmanVertexFit.o $(bin)KinematicConstraints.o $(bin)KinematicFit.o $(bin)SecondVertexFit.o $(bin)TrackPool.o $(bin)VertexConstraints.o $(bin)VertexDbSvc.o $(bin)VertexExtrapolate.o $(bin)VertexFit.o $(bin)VertexFitRefine.o $(bin)VertexParameter.o $(bin)WTrackParameter.o $(bin)VertexDbSvc_dll.o $(bin)VertexDbSvc_load.o $(bin)test_read.o
	$(lib_echo) library
	$(lib_silent) cd $(bin); \
	  $(ar) $(VertexFitlib) $?
...
VertexFitclean ::
	...
	$(cleanup_silent) cd $(bin); /bin/rm -f $(bin)BField.o $(bin)FastVertexFit.o $(bin)GammaShape.o $(bin)HTrackParameter.o $(bin)Helix.o $(bin)KalmanKinematicFit.o $(bin)KalmanVertexFit.o $(bin)KinematicConstraints.o $(bin)KinematicFit.o $(bin)SecondVertexFit.o $(bin)TrackPool.o $(bin)VertexConstraints.o $(bin)VertexDbSvc.o $(bin)VertexExtrapolate.o $(bin)VertexFit.o $(bin)VertexFitRefine.o $(bin)VertexParameter.o $(bin)WTrackParameter.o $(bin)VertexDbSvc_dll.o $(bin)VertexDbSvc_load.o $(bin)test_read.o
...
ifneq ($(MAKECMDGOALS),VertexFitclean)
ifneq ($(MAKECMDGOALS),uninstall)
-include $(bin)$(binobj)VertexExtrapolate.d

$(bin)$(binobj)VertexExtrapolate.d :

$(bin)$(binobj)VertexExtrapolate.o : $(cmt_final_setup_VertexFit)

$(bin)$(binobj)VertexExtrapolate.o : $(src)VertexExtrapolate.cxx
	$(cpp_echo) $(src)VertexExtrapolate.cxx
	$(cpp_silent) $(cppcomp) -MMD -MP -MF $*.d -MQ $@ -o $@ $(use_pp_cppflags) $(VertexFit_pp_cppflags) $(lib_VertexFit_pp_cppflags) $(VertexExtrapolate_pp_cppflags) $(use_cppflags) $(VertexFit_cppflags) $(lib_VertexFit_cppflags) $(VertexExtrapolate_cppflags) $(VertexExtrapolate_cxx_cppflags)  $(src)VertexExtrapolate.cxx
endif
endif

else
$(bin)VertexFit_dependencies.make : $(VertexExtrapolate_cxx_dependencies)

$(bin)VertexFit_dependencies.make : $(src)VertexExtrapolate.cxx

$(bin)$(binobj)VertexExtrapolate.o : $(VertexExtrapolate_cxx_dependencies)
	$(cpp_echo) $(src)VertexExtrapolate.cxx
	$(cpp_silent) $(cppcomp) -o $@ $(use_pp_cppflags) $(VertexFit_pp_cppflags) $(lib_VertexFit_pp_cppflags) $(VertexExtrapolate_pp_cppflags) $(use_cppflags) $(VertexFit_cppflags) $(lib_VertexFit_cppflags) $(VertexExtrapolate_cppflags) $(VertexExtrapolate_cxx_cppflags)  $(src)VertexExtrapolate.cxx
...
ifneq ($(MAKECMDGOALS),VertexFitclean)
ifneq ($(MAKECMDGOALS),uninstall)
-include $(bin)$(binobj)VertexFitRefine.d

$(bin)$(binobj)VertexFitRefine.d :

$(bin)$(binobj)VertexFitRefine.o : $(cmt_final_setup_VertexFit)

$(bin)$(binobj)VertexFitRefine.o : $(src)VertexFitRefine.cxx
	$(cpp_echo) $(src)VertexFitRefine.cxx
	$(cpp_silent) $(cppcomp) -MMD -MP -MF $*.d -MQ $@ -o $@ $(use_pp_cppflags) $(VertexFit_pp_cppflags) $(lib_VertexFit_pp_cppflags) $(VertexFitRefine_pp_cppflags) $(use_cppflags) $(VertexFit_cppflags) $(lib_VertexFit_cppflags) $(VertexFitRefine_cppflags) $(VertexFitRefine_cxx_cppflags)  $(src)VertexFitRefine.cxx
endif
endif

else
$(bin)VertexFit_dependencies.make : $(VertexFitRefine_cxx_dependencies)

$(bin)VertexFit_dependencies.make : $(src)VertexFitRefine.cxx

$(bin)$(binobj)VertexFitRefine.o : $(VertexFitRefine_cxx_dependencies)
	$(cpp_echo) $(src)VertexFitRefine.cxx
	$(cpp_silent) $(cppcomp) -o $@ $(use_pp_cppflags) $(VertexFit_pp_cppflags) $(lib_VertexFit_pp_cppflags) $(VertexFitRefine_pp_cppflags) $(use_cppflags) $(VertexFit_cppflags) $(lib_VertexFit_cppflags) $(VertexFitRefine_cppflags) $(VertexFitRefine_cxx_cppflags)  $(src)VertexFitRefine.cxx
