...
#cmt_local_tagfile = $(Gam4pikpAlg_tag).make
cmt_local_tagfile = $(bin)$(Gam4pikpAlg_tag).make
...
cmt_local_setup_Gam4pikpAlg = $(bin)setup_Gam4pikpAlg$$$$.make
...
Gam4pikpAlg_extratags = -tag_add=target_Gam4pikpAlg

#$(cmt_local_tagfile_Gam4pikpAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Gam4pikpAlg) ::
else
$(cmt_local_tagfile_Gam4pikpAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_Gam4pikpAlg); then /bin/rm -f $(cmt_local_tagfile_Gam4pikpAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(Gam4pikpAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_Gam4pikpAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_Gam4pikpAlg)"; \
	  test ! -f $(cmt_local_setup_Gam4pikpAlg) || \rm -f $(cmt_local_setup_Gam4pikpAlg); \
	  trap '\rm -f $(cmt_local_setup_Gam4pikpAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(Gam4pikpAlg_extratags) show setup >$(cmt_local_setup_Gam4pikpAlg) && \
	  if [ -f $(cmt_final_setup_Gam4pikpAlg) ] && \
	    \cmp -s $(cmt_final_setup_Gam4pikpAlg) $(cmt_local_setup_Gam4pikpAlg); then \
	    \rm $(cmt_local_setup_Gam4pikpAlg); else \
	    \mv -f $(cmt_local_setup_Gam4pikpAlg) $(cmt_final_setup_Gam4pikpAlg); fi
...
not_Gam4pikpAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(Gam4pikpAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
Gam4pikpAlgdirs :
	@if test ! -d $(bin)Gam4pikpAlg; then $(mkdir) -p $(bin)Gam4pikpAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)Gam4pikpAlg
else
Gam4pikpAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)Gam4pikpAlg
#
#$(cmt_local_Gam4pikpAlg_makefile) :: $(Gam4pikpAlg_dependencies) $(cmt_local_tagfile_Gam4pikpAlg) build_library_links dirs Gam4pikpAlgdirs
#else
#$(cmt_local_Gam4pikpAlg_makefile) :: $(Gam4pikpAlg_dependencies) $(cmt_local_tagfile_Gam4pikpAlg) build_library_links dirs
#endif
#else
#$(cmt_local_Gam4pikpAlg_makefile) :: $(cmt_local_tagfile_Gam4pikpAlg)
#endif

ifdef cmt_Gam4pikpAlg_has_target_tag

ifndef QUICK
$(cmt_local_Gam4pikpAlg_makefile) : $(Gam4pikpAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Gam4pikpAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Gam4pikpAlg_extratags) build constituent_config -out=$(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlg
else
$(cmt_local_Gam4pikpAlg_makefile) : $(Gam4pikpAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Gam4pikpAlg) ] || \
	  [ ! -f $(cmt_final_setup_Gam4pikpAlg) ] || \
	  $(not_Gam4pikpAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building Gam4pikpAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(Gam4pikpAlg_extratags) build constituent_config -out=$(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlg; \
	  fi
endif
...
$(cmt_local_Gam4pikpAlg_makefile) : $(Gam4pikpAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building Gam4pikpAlg.make"; \
	  $(cmtexe) -f=$(bin)Gam4pikpAlg.in -tag=$(tags) $(Gam4pikpAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlg
else
$(cmt_local_Gam4pikpAlg_makefile) : $(Gam4pikpAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)Gam4pikpAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_Gam4pikpAlg) ] || \
	  [ ! -f $(cmt_final_setup_Gam4pikpAlg) ] || \
	  $(not_Gam4pikpAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(Gam4pikpAlg_extratags) build constituent_makefile -out=$(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlg

Gam4pikpAlg :: $(Gam4pikpAlg_dependencies) $(cmt_local_Gam4pikpAlg_makefile) dirs Gam4pikpAlgdirs
	$(echo) "(constituents.make) Starting Gam4pikpAlg"
	@if test -f $(cmt_local_Gam4pikpAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlg
	$(echo) "(constituents.make) Gam4pikpAlg done"

clean :: Gam4pikpAlgclean

Gam4pikpAlgclean :: $(Gam4pikpAlgclean_dependencies) ##$(cmt_local_Gam4pikpAlg_makefile)
	$(echo) "(constituents.make) Starting Gam4pikpAlgclean"
	@-if test -f $(cmt_local_Gam4pikpAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlgclean; \
	fi
	$(echo) "(constituents.make) Gam4pikpAlgclean done"
#	@-$(MAKE) -f $(cmt_local_Gam4pikpAlg_makefile) Gam4pikpAlgclean

##	  /bin/rm -f $(cmt_local_Gam4pikpAlg_makefile) $(bin)Gam4pikpAlg_dependencies.make

install :: Gam4pikpAlginstall

Gam4pikpAlginstall :: $(Gam4pikpAlg_dependencies) $(cmt_local_Gam4pikpAlg_makefile)
	$(echo) "(constituents.make) Starting install Gam4pikpAlg"
	@-$(MAKE) -f $(cmt_local_Gam4pikpAlg_makefile) install
	$(echo) "(constituents.make) install Gam4pikpAlg done"

uninstall : Gam4pikpAlguninstall

$(foreach d,$(Gam4pikpAlg_dependencies),$(eval $(d)uninstall_dependencies += Gam4pikpAlguninstall))

Gam4pikpAlguninstall : $(Gam4pikpAlguninstall_dependencies) ##$(cmt_local_Gam4pikpAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall Gam4pikpAlg"
	@if test -f $(cmt_local_Gam4pikpAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_Gam4pikpAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_Gam4pikpAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall Gam4pikpAlg done"

remove_library_links :: Gam4pikpAlguninstall
...
#cmt_local_tagfile_install_runtime = $(Gam4pikpAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(Gam4pikpAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)Gam4pikpAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)Gam4pikpAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(Gam4pikpAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(Gam4pikpAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)Gam4pikpAlg_configsetup.make
...
#cmt_local_tagfile_config = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_config = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)Gam4pikpAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(Gam4pikpAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Gam4pikpAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)Gam4pikpAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)Gam4pikpAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(Gam4pikpAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Gam4pikpAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)Gam4pikpAlg_makesetup.make
...
#cmt_local_tagfile_make = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_make = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)Gam4pikpAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(Gam4pikpAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Gam4pikpAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)Gam4pikpAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)Gam4pikpAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(Gam4pikpAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Gam4pikpAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)Gam4pikpAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)Gam4pikpAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(Gam4pikpAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Gam4pikpAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)Gam4pikpAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)Gam4pikpAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(Gam4pikpAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Gam4pikpAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)Gam4pikpAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)Gam4pikpAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(Gam4pikpAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Gam4pikpAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)Gam4pikpAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)Gam4pikpAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(Gam4pikpAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Gam4pikpAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)Gam4pikpAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)Gam4pikpAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Gam4pikpAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Gam4pikpAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Gam4pikpAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Gam4pikpAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Gam4pikpAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Gam4pikpAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
