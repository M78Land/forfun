...
#cmt_local_tagfile = $(PpjrhopiAlg_tag).make
cmt_local_tagfile = $(bin)$(PpjrhopiAlg_tag).make
...
cmt_local_setup_PpjrhopiAlg = $(bin)setup_PpjrhopiAlg$$$$.make
...
PpjrhopiAlg_extratags = -tag_add=target_PpjrhopiAlg

#$(cmt_local_tagfile_PpjrhopiAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_PpjrhopiAlg) ::
else
$(cmt_local_tagfile_PpjrhopiAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_PpjrhopiAlg); then /bin/rm -f $(cmt_local_tagfile_PpjrhopiAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_PpjrhopiAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_PpjrhopiAlg)"; \
	  test ! -f $(cmt_local_setup_PpjrhopiAlg) || \rm -f $(cmt_local_setup_PpjrhopiAlg); \
	  trap '\rm -f $(cmt_local_setup_PpjrhopiAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_extratags) show setup >$(cmt_local_setup_PpjrhopiAlg) && \
	  if [ -f $(cmt_final_setup_PpjrhopiAlg) ] && \
	    \cmp -s $(cmt_final_setup_PpjrhopiAlg) $(cmt_local_setup_PpjrhopiAlg); then \
	    \rm $(cmt_local_setup_PpjrhopiAlg); else \
	    \mv -f $(cmt_local_setup_PpjrhopiAlg) $(cmt_final_setup_PpjrhopiAlg); fi
...
not_PpjrhopiAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(PpjrhopiAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
PpjrhopiAlgdirs :
	@if test ! -d $(bin)PpjrhopiAlg; then $(mkdir) -p $(bin)PpjrhopiAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)PpjrhopiAlg
else
PpjrhopiAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)PpjrhopiAlg
#
#$(cmt_local_PpjrhopiAlg_makefile) :: $(PpjrhopiAlg_dependencies) $(cmt_local_tagfile_PpjrhopiAlg) build_library_links dirs PpjrhopiAlgdirs
#else
#$(cmt_local_PpjrhopiAlg_makefile) :: $(PpjrhopiAlg_dependencies) $(cmt_local_tagfile_PpjrhopiAlg) build_library_links dirs
#endif
#else
#$(cmt_local_PpjrhopiAlg_makefile) :: $(cmt_local_tagfile_PpjrhopiAlg)
#endif

ifdef cmt_PpjrhopiAlg_has_target_tag

ifndef QUICK
$(cmt_local_PpjrhopiAlg_makefile) : $(PpjrhopiAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building PpjrhopiAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_extratags) build constituent_config -out=$(cmt_local_PpjrhopiAlg_makefile) PpjrhopiAlg
else
$(cmt_local_PpjrhopiAlg_makefile) : $(PpjrhopiAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PpjrhopiAlg) ] || \
	  [ ! -f $(cmt_final_setup_PpjrhopiAlg) ] || \
	  $(not_PpjrhopiAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building PpjrhopiAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_extratags) build constituent_config -out=$(cmt_local_PpjrhopiAlg_makefile) PpjrhopiAlg; \
	  fi
endif
...
$(cmt_local_PpjrhopiAlg_makefile) : $(PpjrhopiAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building PpjrhopiAlg.make"; \
	  $(cmtexe) -f=$(bin)PpjrhopiAlg.in -tag=$(tags) $(PpjrhopiAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_PpjrhopiAlg_makefile) PpjrhopiAlg
else
$(cmt_local_PpjrhopiAlg_makefile) : $(PpjrhopiAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)PpjrhopiAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PpjrhopiAlg) ] || \
	  [ ! -f $(cmt_final_setup_PpjrhopiAlg) ] || \
	  $(not_PpjrhopiAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_extratags) build constituent_makefile -out=$(cmt_local_PpjrhopiAlg_makefile) PpjrhopiAlg

PpjrhopiAlg :: $(PpjrhopiAlg_dependencies) $(cmt_local_PpjrhopiAlg_makefile) dirs PpjrhopiAlgdirs
	$(echo) "(constituents.make) Starting PpjrhopiAlg"
	@if test -f $(cmt_local_PpjrhopiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local
lgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_PpjrhopiAlg_check_install_runtime = $(bin)setup_PpjrhopiAlg_check_install_runtime$$$$.make
...
PpjrhopiAlg_check_install_runtime_extratags = -tag_add=target_PpjrhopiAlg_check_install_runtime

#$(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_PpjrhopiAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_PpjrhopiAlg_check_install_runtime) || \rm -f $(cmt_local_setup_PpjrhopiAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_PpjrhopiAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_PpjrhopiAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_PpjrhopiAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_PpjrhopiAlg_check_install_runtime) $(cmt_local_setup_PpjrhopiAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_PpjrhopiAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_PpjrhopiAlg_check_install_runtime) $(cmt_final_setup_PpjrhopiAlg_check_install_runtime); fi
...
not_PpjrhopiAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(PpjrhopiAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
PpjrhopiAlg_check_install_runtimedirs :
	@if test ! -d $(bin)PpjrhopiAlg_check_install_runtime; then $(mkdir) -p $(bin)PpjrhopiAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)PpjrhopiAlg_check_install_runtime
else
PpjrhopiAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)PpjrhopiAlg_check_install_runtime
#
#$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) :: $(PpjrhopiAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime) build_library_links dirs PpjrhopiAlg_check_install_runtimedirs
#else
#$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) :: $(PpjrhopiAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime)
#endif

ifdef cmt_PpjrhopiAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) : $(PpjrhopiAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building PpjrhopiAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtime
else
$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) : $(PpjrhopiAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_PpjrhopiAlg_check_install_runtime) ] || \
	  $(not_PpjrhopiAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building PpjrhopiAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) : $(PpjrhopiAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building PpjrhopiAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)PpjrhopiAlg_check_install_runtime.in -tag=$(tags) $(PpjrhopiAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtime
else
$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) : $(PpjrhopiAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)PpjrhopiAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PpjrhopiAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_PpjrhopiAlg_check_install_runtime) ] || \
	  $(not_PpjrhopiAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(PpjrhopiAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtime

PpjrhopiAlg_check_install_runtime :: $(PpjrhopiAlg_check_install_runtime_dependencies) $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) dirs PpjrhopiAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting PpjrhopiAlg_check_install_runtime"
	@if test -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtime
	$(echo) "(constituents.make) PpjrhopiAlg_check_install_runtime done"

clean :: PpjrhopiAlg_check_install_runtimeclean

PpjrhopiAlg_check_install_runtimeclean :: $(PpjrhopiAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting PpjrhopiAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) PpjrhopiAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) PpjrhopiAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) $(bin)PpjrhopiAlg_check_install_runtime_dependencies.make

install :: PpjrhopiAlg_check_install_runtimeinstall

PpjrhopiAlg_check_install_runtimeinstall :: $(PpjrhopiAlg_check_install_runtime_dependencies) $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install PpjrhopiAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install PpjrhopiAlg_check_install_runtime done"

uninstall : PpjrhopiAlg_check_install_runtimeuninstall

$(foreach d,$(PpjrhopiAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += PpjrhopiAlg_check_install_runtimeuninstall))

PpjrhopiAlg_check_install_runtimeuninstall : $(PpjrhopiAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_PpjrhopiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall PpjrhopiAlg_check_install_runtime"
	@if test -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_PpjrhopiAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall PpjrhopiAlg_check_install_runtime done"

remove_library_links :: PpjrhopiAlg_check_install_runtimeuninstall
