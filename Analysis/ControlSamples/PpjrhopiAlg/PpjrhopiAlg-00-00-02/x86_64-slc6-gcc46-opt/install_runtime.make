...
jobOptions_Ppjrhopi_txt_dependencies = ../share/jobOptions_Ppjrhopi.txt
...
install_runtimeinstall :: ${install_dir}/jobOptions_Ppjrhopi.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_Ppjrhopi.txt :: ../share/jobOptions_Ppjrhopi.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_Ppjrhopi.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_Ppjrhopi.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_Ppjrhopi.txt" "$(install_dir)" "cp -R" ; \
	fi
