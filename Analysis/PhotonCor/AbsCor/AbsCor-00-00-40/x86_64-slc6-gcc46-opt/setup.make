...
# use Identifier Identifier-* DetectorDescription
# use EmcRecEventModel EmcRecEventModel-* Emc
# use EmcShEnCalibSvc EmcShEnCalibSvc-* Emc
#   use BesPolicy BesPolicy-01-* 
#   use GaudiInterface GaudiInterface-01-* External
#   use BesCLHEP * External
...
use BesBoost BesBoost-00-00-01 External (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.8)
...
use OfflineEventLoopMgr OfflineEventLoopMgr-00-00-15 Control (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.8)
use EmcShEnCalibSvc EmcShEnCalibSvc-00-00-01 Emc (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.8)
