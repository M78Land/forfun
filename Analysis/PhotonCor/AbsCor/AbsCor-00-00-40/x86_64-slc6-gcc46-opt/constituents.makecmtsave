...
#cmt_local_tagfile = $(AbsCor_tag).make
cmt_local_tagfile = $(bin)$(AbsCor_tag).make
...
cmt_local_setup_AbsCor = $(bin)setup_AbsCor$$$$.make
...
AbsCor_extratags = -tag_add=target_AbsCor

#$(cmt_local_tagfile_AbsCor) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_AbsCor) ::
else
$(cmt_local_tagfile_AbsCor) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_AbsCor); then /bin/rm -f $(cmt_local_tagfile_AbsCor); fi ; \
	  $(cmtexe) -tag=$(tags) $(AbsCor_extratags) build tag_makefile >>$(cmt_local_tagfile_AbsCor)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_AbsCor)"; \
	  test ! -f $(cmt_local_setup_AbsCor) || \rm -f $(cmt_local_setup_AbsCor); \
	  trap '\rm -f $(cmt_local_setup_AbsCor)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(AbsCor_extratags) show setup >$(cmt_local_setup_AbsCor) && \
	  if [ -f $(cmt_final_setup_AbsCor) ] && \
	    \cmp -s $(cmt_final_setup_AbsCor) $(cmt_local_setup_AbsCor); then \
	    \rm $(cmt_local_setup_AbsCor); else \
	    \mv -f $(cmt_local_setup_AbsCor) $(cmt_final_setup_AbsCor); fi
...
not_AbsCor_dependencies = { n=0; for p in $?; do m=0; for d in $(AbsCor_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
AbsCordirs :
	@if test ! -d $(bin)AbsCor; then $(mkdir) -p $(bin)AbsCor; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)AbsCor
else
AbsCordirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)AbsCor
#
#$(cmt_local_AbsCor_makefile) :: $(AbsCor_dependencies) $(cmt_local_tagfile_AbsCor) build_library_links dirs AbsCordirs
#else
#$(cmt_local_AbsCor_makefile) :: $(AbsCor_dependencies) $(cmt_local_tagfile_AbsCor) build_library_links dirs
#endif
#else
#$(cmt_local_AbsCor_makefile) :: $(cmt_local_tagfile_AbsCor)
#endif

ifdef cmt_AbsCor_has_target_tag

ifndef QUICK
$(cmt_local_AbsCor_makefile) : $(AbsCor_dependencies) build_library_links
	$(echo) "(constituents.make) Building AbsCor.make"; \
	  $(cmtexe) -tag=$(tags) $(AbsCor_extratags) build constituent_config -out=$(cmt_local_AbsCor_makefile) AbsCor
else
$(cmt_local_AbsCor_makefile) : $(AbsCor_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_AbsCor) ] || \
	  [ ! -f $(cmt_final_setup_AbsCor) ] || \
	  $(not_AbsCor_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building AbsCor.make"; \
	  $(cmtexe) -tag=$(tags) $(AbsCor_extratags) build constituent_config -out=$(cmt_local_AbsCor_makefile) AbsCor; \
	  fi
endif
...
$(cmt_local_AbsCor_makefile) : $(AbsCor_dependencies) build_library_links
	$(echo) "(constituents.make) Building AbsCor.make"; \
	  $(cmtexe) -f=$(bin)AbsCor.in -tag=$(tags) $(AbsCor_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_AbsCor_makefile) AbsCor
else
$(cmt_local_AbsCor_makefile) : $(AbsCor_dependencies) $(cmt_build_library_linksstamp) $(bin)AbsCor.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_AbsCor) ] || \
	  [ ! -f $(cmt_final_setup_AbsCor) ] || \
	  $(not_AbsCor_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(AbsCor_extratags) build constituent_makefile -out=$(cmt_local_AbsCor_makefile) AbsCor

AbsCor :: $(AbsCor_dependencies) $(cmt_local_AbsCor_makefile) dirs AbsCordirs
	$(echo) "(constituents.make) Starting AbsCor"
	@if test -f $(cmt_local_AbsCor_makefile); then \
	  $(MAKE) -f $(cmt_local_AbsCor_makefile) AbsCor; \
	  fi
#	@$(MAKE) -f $(cmt_local_AbsCor_makefile) AbsCor
	$(echo) "(constituents.make) AbsCor done"

clean :: AbsCorclean

AbsCorclean :: $(AbsCorclean_dependencies) ##$(cmt_local_AbsCor_makefile)
	$(echo) "(constituents.make) Starting AbsCorclean"
	@-if test -f $(cmt_local_AbsCor_makefile); then \
	  $(MAKE) -f $(cmt_local_AbsCor_makefile) AbsCorclean; \
	fi
	$(echo) "(constituents.make) AbsCorclean done"
#	@-$(MAKE) -f $(cmt_local_AbsCor_makefile) AbsCorclean

##	  /bin/rm -f $(cmt_local_AbsCor_makefile) $(bin)AbsCor_dependencies.make

install :: AbsCorinstall

AbsCorinstall :: $(AbsCor_dependencies) $(cmt_local_AbsCor_makefile)
	$(echo) "(constituents.make) Starting install AbsCor"
	@-$(MAKE) -f $(cmt_local_AbsCor_makefile) install
	$(echo) "(constituents.make) install AbsCor done"

uninstall : AbsCoruninstall

$(foreach d,$(AbsCor_dependencies),$(eval $(d)uninstall_dependencies += AbsCoruninstall))

AbsCoruninstall : $(AbsCoruninstall_dependencies) ##$(cmt_local_AbsCor_makefile)
	$(echo) "(constituents.make) Starting uninstall AbsCor"
	@if test -f $(cmt_local_AbsCor_makefile); then \
	  $(MAKE) -f $(cmt_local_AbsCor_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_AbsCor_makefile) uninstall
	$(echo) "(constituents.make) uninstall AbsCor done"

remove_library_links :: AbsCoruninstall
...
#cmt_local_tagfile_config = $(AbsCor_tag)_config.make
cmt_local_tagfile_config = $(bin)$(AbsCor_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)AbsCor_configsetup.make
...
#cmt_local_tagfile_config = $(AbsCor_tag).make
cmt_local_tagfile_config = $(bin)$(AbsCor_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)AbsCorsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(AbsCor_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(AbsCor_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)AbsCor_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(AbsCor_tag).make
cmt_local_tagfile_install_includes = $(bin)$(AbsCor_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)AbsCorsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(AbsCor_tag)_make.make
cmt_local_tagfile_make = $(bin)$(AbsCor_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)AbsCor_makesetup.make
...
#cmt_local_tagfile_make = $(AbsCor_tag).make
cmt_local_tagfile_make = $(bin)$(AbsCor_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)AbsCorsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(AbsCor_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(AbsCor_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)AbsCor_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(AbsCor_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(AbsCor_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)AbsCorsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(AbsCor_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(AbsCor_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)AbsCor_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(AbsCor_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(AbsCor_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)AbsCorsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(AbsCor_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(AbsCor_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)AbsCor_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(AbsCor_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(AbsCor_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)AbsCorsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(AbsCor_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(AbsCor_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)AbsCor_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(AbsCor_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(AbsCor_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)AbsCorsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(AbsCor_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(AbsCor_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)AbsCor_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(AbsCor_tag).make
cmt_local_tagfile_TestProject = $(bin)$(AbsCor_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)AbsCorsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(AbsCor_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(AbsCor_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)AbsCor_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(AbsCor_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(AbsCor_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)AbsCorsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(AbsCor_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(AbsCor_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)AbsCor_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(AbsCor_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(AbsCor_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)AbsCorsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
#cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(AbsCor_tag)_OfflineEventLoopMgr_check_install_joboptions.make
cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(bin)$(AbsCor_tag)_OfflineEventLoopMgr_check_install_joboptions.make
...
#cmt_final_setup_OfflineEventLoopMgr_check_install_joboptions = $(bin)AbsCor_OfflineEventLoopMgr_check_install_joboptionssetup.make
...
#cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(AbsCor_tag).make
cmt_local_tagfile_OfflineEventLoopMgr_check_install_joboptions = $(bin)$(AbsCor_tag).make
cmt_final_setup_OfflineEventLoopMgr_check_install_joboptions = $(bin)setup.make
#cmt_final_setup_OfflineEventLoopMgr_check_install_joboptions = $(bin)AbsCorsetup.make
cmt_local_OfflineEventLoopMgr_check_install_joboptions_makefile = $(bin)OfflineEventLoopMgr_check_install_joboptions.make
