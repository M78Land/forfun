...
#cmt_local_tagfile = $(DTagTool_tag).make
cmt_local_tagfile = $(bin)$(DTagTool_tag).make
...
cmt_local_setup_DTagTool = $(bin)setup_DTagTool$$$$.make
...
DTagTool_extratags = -tag_add=target_DTagTool

#$(cmt_local_tagfile_DTagTool) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DTagTool) ::
else
$(cmt_local_tagfile_DTagTool) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DTagTool); then /bin/rm -f $(cmt_local_tagfile_DTagTool); fi ; \
	  $(cmtexe) -tag=$(tags) $(DTagTool_extratags) build tag_makefile >>$(cmt_local_tagfile_DTagTool)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DTagTool)"; \
	  test ! -f $(cmt_local_setup_DTagTool) || \rm -f $(cmt_local_setup_DTagTool); \
	  trap '\rm -f $(cmt_local_setup_DTagTool)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DTagTool_extratags) show setup >$(cmt_local_setup_DTagTool) && \
	  if [ -f $(cmt_final_setup_DTagTool) ] && \
	    \cmp -s $(cmt_final_setup_DTagTool) $(cmt_local_setup_DTagTool); then \
	    \rm $(cmt_local_setup_DTagTool); else \
	    \mv -f $(cmt_local_setup_DTagTool) $(cmt_final_setup_DTagTool); fi
...
not_DTagTool_dependencies = { n=0; for p in $?; do m=0; for d in $(DTagTool_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DTagTooldirs :
	@if test ! -d $(bin)DTagTool; then $(mkdir) -p $(bin)DTagTool; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DTagTool
else
DTagTooldirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DTagTool
#
#$(cmt_local_DTagTool_makefile) :: $(DTagTool_dependencies) $(cmt_local_tagfile_DTagTool) build_library_links dirs DTagTooldirs
#else
#$(cmt_local_DTagTool_makefile) :: $(DTagTool_dependencies) $(cmt_local_tagfile_DTagTool) build_library_links dirs
#endif
#else
#$(cmt_local_DTagTool_makefile) :: $(cmt_local_tagfile_DTagTool)
#endif

ifdef cmt_DTagTool_has_target_tag

ifndef QUICK
$(cmt_local_DTagTool_makefile) : $(DTagTool_dependencies) build_library_links
	$(echo) "(constituents.make) Building DTagTool.make"; \
	  $(cmtexe) -tag=$(tags) $(DTagTool_extratags) build constituent_config -out=$(cmt_local_DTagTool_makefile) DTagTool
else
$(cmt_local_DTagTool_makefile) : $(DTagTool_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DTagTool) ] || \
	  [ ! -f $(cmt_final_setup_DTagTool) ] || \
	  $(not_DTagTool_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DTagTool.make"; \
	  $(cmtexe) -tag=$(tags) $(DTagTool_extratags) build constituent_config -out=$(cmt_local_DTagTool_makefile) DTagTool; \
	  fi
endif
...
$(cmt_local_DTagTool_makefile) : $(DTagTool_dependencies) build_library_links
	$(echo) "(constituents.make) Building DTagTool.make"; \
	  $(cmtexe) -f=$(bin)DTagTool.in -tag=$(tags) $(DTagTool_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DTagTool_makefile) DTagTool
else
$(cmt_local_DTagTool_makefile) : $(DTagTool_dependencies) $(cmt_build_library_linksstamp) $(bin)DTagTool.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DTagTool) ] || \
	  [ ! -f $(cmt_final_setup_DTagTool) ] || \
	  $(not_DTagTool_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DTagTool_extratags) build constituent_makefile -out=$(cmt_local_DTagTool_makefile) DTagTool

DTagTool :: $(DTagTool_dependencies) $(cmt_local_DTagTool_makefile) dirs DTagTooldirs
	$(echo) "(constituents.make) Starting DTagTool"
	@if test -f $(cmt_local_DTagTool_makefile); then \
	  $(MAKE) -f $(cmt_local_DTagTool_makefile) DTagTool; \
	  fi
#	@$(MAKE) -f $(cmt_local_DTagTool_makefile) DTagTool
	$(echo) "(constituents.make) DTagTool done"

clean :: DTagToolclean

DTagToolclean :: $(DTagToolclean_dependencies) ##$(cmt_local_DTagTool_makefile)
	$(echo) "(constituents.make) Starting DTagToolclean"
	@-if test -f $(cmt_local_DTagTool_makefile); then \
	  $(MAKE) -f $(cmt_local_DTagTool_makefile) DTagToolclean; \
	fi
	$(echo) "(constituents.make) DTagToolclean done"
#	@-$(MAKE) -f $(cmt_local_DTagTool_makefile) DTagToolclean

##	  /bin/rm -f $(cmt_local_DTagTool_makefile) $(bin)DTagTool_dependencies.make

install :: DTagToolinstall

DTagToolinstall :: $(DTagTool_dependencies) $(cmt_local_DTagTool_makefile)
	$(echo) "(constituents.make) Starting install DTagTool"
	@-$(MAKE) -f $(cmt_local_DTagTool_makefile) install
	$(echo) "(constituents.make) install DTagTool done"

uninstall : DTagTooluninstall

$(foreach d,$(DTagTool_dependencies),$(eval $(d)uninstall_dependencies += DTagTooluninstall))

DTagTooluninstall : $(DTagTooluninstall_dependencies) ##$(cmt_local_DTagTool_makefile)
	$(echo) "(constituents.make) Starting uninstall DTagTool"
	@if test -f $(cmt_local_DTagTool_makefile); then \
	  $(MAKE) -f $(cmt_local_DTagTool_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DTagTool_makefile) uninstall
	$(echo) "(constituents.make) uninstall DTagTool done"

remove_library_links :: DTagTooluninstall
...
#cmt_local_tagfile_config = $(DTagTool_tag)_config.make
cmt_local_tagfile_config = $(bin)$(DTagTool_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)DTagTool_configsetup.make
...
#cmt_local_tagfile_config = $(DTagTool_tag).make
cmt_local_tagfile_config = $(bin)$(DTagTool_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)DTagToolsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(DTagTool_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DTagTool_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DTagTool_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DTagTool_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DTagTool_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DTagToolsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DTagTool_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DTagTool_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DTagTool_makesetup.make
...
#cmt_local_tagfile_make = $(DTagTool_tag).make
cmt_local_tagfile_make = $(bin)$(DTagTool_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DTagToolsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DTagTool_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DTagTool_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DTagTool_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DTagTool_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DTagTool_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DTagToolsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DTagTool_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DTagTool_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DTagTool_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DTagTool_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DTagTool_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DTagToolsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DTagTool_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DTagTool_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DTagTool_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DTagTool_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DTagTool_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DTagToolsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DTagTool_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DTagTool_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DTagTool_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DTagTool_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DTagTool_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DTagToolsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DTagTool_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DTagTool_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DTagTool_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DTagTool_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DTagTool_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DTagToolsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DTagTool_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DTagTool_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DTagTool_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DTagTool_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DTagTool_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DTagToolsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DTagTool_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DTagTool_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DTagTool_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DTagTool_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DTagTool_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DTagToolsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
