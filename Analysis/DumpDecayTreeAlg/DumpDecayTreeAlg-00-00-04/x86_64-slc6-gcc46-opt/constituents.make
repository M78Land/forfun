...
#cmt_local_tagfile = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile = $(bin)$(DumpDecayTreeAlg_tag).make
...
cmt_local_setup_DumpDecayTreeAlg = $(bin)setup_DumpDecayTreeAlg$$$$.make
...
DumpDecayTreeAlg_extratags = -tag_add=target_DumpDecayTreeAlg

#$(cmt_local_tagfile_DumpDecayTreeAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DumpDecayTreeAlg) ::
else
$(cmt_local_tagfile_DumpDecayTreeAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_DumpDecayTreeAlg); then /bin/rm -f $(cmt_local_tagfile_DumpDecayTreeAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(DumpDecayTreeAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_DumpDecayTreeAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_DumpDecayTreeAlg)"; \
	  test ! -f $(cmt_local_setup_DumpDecayTreeAlg) || \rm -f $(cmt_local_setup_DumpDecayTreeAlg); \
	  trap '\rm -f $(cmt_local_setup_DumpDecayTreeAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(DumpDecayTreeAlg_extratags) show setup >$(cmt_local_setup_DumpDecayTreeAlg) && \
	  if [ -f $(cmt_final_setup_DumpDecayTreeAlg) ] && \
	    \cmp -s $(cmt_final_setup_DumpDecayTreeAlg) $(cmt_local_setup_DumpDecayTreeAlg); then \
	    \rm $(cmt_local_setup_DumpDecayTreeAlg); else \
	    \mv -f $(cmt_local_setup_DumpDecayTreeAlg) $(cmt_final_setup_DumpDecayTreeAlg); fi
...
not_DumpDecayTreeAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(DumpDecayTreeAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DumpDecayTreeAlgdirs :
	@if test ! -d $(bin)DumpDecayTreeAlg; then $(mkdir) -p $(bin)DumpDecayTreeAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DumpDecayTreeAlg
else
DumpDecayTreeAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)DumpDecayTreeAlg
#
#$(cmt_local_DumpDecayTreeAlg_makefile) :: $(DumpDecayTreeAlg_dependencies) $(cmt_local_tagfile_DumpDecayTreeAlg) build_library_links dirs DumpDecayTreeAlgdirs
#else
#$(cmt_local_DumpDecayTreeAlg_makefile) :: $(DumpDecayTreeAlg_dependencies) $(cmt_local_tagfile_DumpDecayTreeAlg) build_library_links dirs
#endif
#else
#$(cmt_local_DumpDecayTreeAlg_makefile) :: $(cmt_local_tagfile_DumpDecayTreeAlg)
#endif

ifdef cmt_DumpDecayTreeAlg_has_target_tag

ifndef QUICK
$(cmt_local_DumpDecayTreeAlg_makefile) : $(DumpDecayTreeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building DumpDecayTreeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DumpDecayTreeAlg_extratags) build constituent_config -out=$(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlg
else
$(cmt_local_DumpDecayTreeAlg_makefile) : $(DumpDecayTreeAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DumpDecayTreeAlg) ] || \
	  [ ! -f $(cmt_final_setup_DumpDecayTreeAlg) ] || \
	  $(not_DumpDecayTreeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DumpDecayTreeAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DumpDecayTreeAlg_extratags) build constituent_config -out=$(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlg; \
	  fi
endif
...
$(cmt_local_DumpDecayTreeAlg_makefile) : $(DumpDecayTreeAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building DumpDecayTreeAlg.make"; \
	  $(cmtexe) -f=$(bin)DumpDecayTreeAlg.in -tag=$(tags) $(DumpDecayTreeAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlg
else
$(cmt_local_DumpDecayTreeAlg_makefile) : $(DumpDecayTreeAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)DumpDecayTreeAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DumpDecayTreeAlg) ] || \
	  [ ! -f $(cmt_final_setup_DumpDecayTreeAlg) ] || \
	  $(not_DumpDecayTreeAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DumpDecayTreeAlg_extratags) build constituent_makefile -out=$(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlg

DumpDecayTreeAlg :: $(DumpDecayTreeAlg_dependencies) $(cmt_local_DumpDecayTreeAlg_makefile) dirs DumpDecayTreeAlgdirs
	$(echo) "(constituents.make) Starting DumpDecayTreeAlg"
	@if test -f $(cmt_local_DumpDecayTreeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlg
	$(echo) "(constituents.make) DumpDecayTreeAlg done"

clean :: DumpDecayTreeAlgclean

DumpDecayTreeAlgclean :: $(DumpDecayTreeAlgclean_dependencies) ##$(cmt_local_DumpDecayTreeAlg_makefile)
	$(echo) "(constituents.make) Starting DumpDecayTreeAlgclean"
	@-if test -f $(cmt_local_DumpDecayTreeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlgclean; \
	fi
	$(echo) "(constituents.make) DumpDecayTreeAlgclean done"
#	@-$(MAKE) -f $(cmt_local_DumpDecayTreeAlg_makefile) DumpDecayTreeAlgclean

##	  /bin/rm -f $(cmt_local_DumpDecayTreeAlg_makefile) $(bin)DumpDecayTreeAlg_dependencies.make

install :: DumpDecayTreeAlginstall

DumpDecayTreeAlginstall :: $(DumpDecayTreeAlg_dependencies) $(cmt_local_DumpDecayTreeAlg_makefile)
	$(echo) "(constituents.make) Starting install DumpDecayTreeAlg"
	@-$(MAKE) -f $(cmt_local_DumpDecayTreeAlg_makefile) install
	$(echo) "(constituents.make) install DumpDecayTreeAlg done"

uninstall : DumpDecayTreeAlguninstall

$(foreach d,$(DumpDecayTreeAlg_dependencies),$(eval $(d)uninstall_dependencies += DumpDecayTreeAlguninstall))

DumpDecayTreeAlguninstall : $(DumpDecayTreeAlguninstall_dependencies) ##$(cmt_local_DumpDecayTreeAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall DumpDecayTreeAlg"
	@if test -f $(cmt_local_DumpDecayTreeAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DumpDecayTreeAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DumpDecayTreeAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall DumpDecayTreeAlg done"

remove_library_links :: DumpDecayTreeAlguninstall
...
#cmt_local_tagfile_config = $(DumpDecayTreeAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(DumpDecayTreeAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)DumpDecayTreeAlg_configsetup.make
...
#cmt_local_tagfile_config = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_config = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(DumpDecayTreeAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DumpDecayTreeAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)DumpDecayTreeAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(DumpDecayTreeAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DumpDecayTreeAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)DumpDecayTreeAlg_makesetup.make
...
#cmt_local_tagfile_make = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_make = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(DumpDecayTreeAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DumpDecayTreeAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)DumpDecayTreeAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(DumpDecayTreeAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DumpDecayTreeAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)DumpDecayTreeAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(DumpDecayTreeAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DumpDecayTreeAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)DumpDecayTreeAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(DumpDecayTreeAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DumpDecayTreeAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)DumpDecayTreeAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(DumpDecayTreeAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DumpDecayTreeAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)DumpDecayTreeAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(DumpDecayTreeAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DumpDecayTreeAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)DumpDecayTreeAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DumpDecayTreeAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DumpDecayTreeAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DumpDecayTreeAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DumpDecayTreeAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DumpDecayTreeAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DumpDecayTreeAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
