...
#cmt_local_tagfile = $(ParticleID_tag).make
cmt_local_tagfile = $(bin)$(ParticleID_tag).make
...
cmt_local_setup_ParticleID = $(bin)setup_ParticleID$$$$.make
...
ParticleID_extratags = -tag_add=target_ParticleID

#$(cmt_local_tagfile_ParticleID) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_ParticleID) ::
else
$(cmt_local_tagfile_ParticleID) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_ParticleID); then /bin/rm -f $(cmt_local_tagfile_ParticleID); fi ; \
	  $(cmtexe) -tag=$(tags) $(ParticleID_extratags) build tag_makefile >>$(cmt_local_tagfile_ParticleID)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_ParticleID)"; \
	  test ! -f $(cmt_local_setup_ParticleID) || \rm -f $(cmt_local_setup_ParticleID); \
	  trap '\rm -f $(cmt_local_setup_ParticleID)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(ParticleID_extratags) show setup >$(cmt_local_setup_ParticleID) && \
	  if [ -f $(cmt_final_setup_ParticleID) ] && \
	    \cmp -s $(cmt_final_setup_ParticleID) $(cmt_local_setup_ParticleID); then \
	    \rm $(cmt_local_setup_ParticleID); else \
	    \mv -f $(cmt_local_setup_ParticleID) $(cmt_final_setup_ParticleID); fi
...
not_ParticleID_dependencies = { n=0; for p in $?; do m=0; for d in $(ParticleID_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
ParticleIDdirs :
	@if test ! -d $(bin)ParticleID; then $(mkdir) -p $(bin)ParticleID; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)ParticleID
else
ParticleIDdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)ParticleID
#
#$(cmt_local_ParticleID_makefile) :: $(ParticleID_dependencies) $(cmt_local_tagfile_ParticleID) build_library_links dirs ParticleIDdirs
#else
#$(cmt_local_ParticleID_makefile) :: $(ParticleID_dependencies) $(cmt_local_tagfile_ParticleID) build_library_links dirs
#endif
#else
#$(cmt_local_ParticleID_makefile) :: $(cmt_local_tagfile_ParticleID)
#endif

ifdef cmt_ParticleID_has_target_tag

ifndef QUICK
$(cmt_local_ParticleID_makefile) : $(ParticleID_dependencies) build_library_links
	$(echo) "(constituents.make) Building ParticleID.make"; \
	  $(cmtexe) -tag=$(tags) $(ParticleID_extratags) build constituent_config -out=$(cmt_local_ParticleID_makefile) ParticleID
else
$(cmt_local_ParticleID_makefile) : $(ParticleID_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ParticleID) ] || \
	  [ ! -f $(cmt_final_setup_ParticleID) ] || \
	  $(not_ParticleID_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building ParticleID.make"; \
	  $(cmtexe) -tag=$(tags) $(ParticleID_extratags) build constituent_config -out=$(cmt_local_ParticleID_makefile) ParticleID; \
	  fi
endif
...
$(cmt_local_ParticleID_makefile) : $(ParticleID_dependencies) build_library_links
	$(echo) "(constituents.make) Building ParticleID.make"; \
	  $(cmtexe) -f=$(bin)ParticleID.in -tag=$(tags) $(ParticleID_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_ParticleID_makefile) ParticleID
else
$(cmt_local_ParticleID_makefile) : $(ParticleID_dependencies) $(cmt_build_library_linksstamp) $(bin)ParticleID.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ParticleID) ] || \
	  [ ! -f $(cmt_final_setup_ParticleID) ] || \
	  $(not_ParticleID_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(ParticleID_extratags) build constituent_makefile -out=$(cmt_local_ParticleID_makefile) ParticleID

ParticleID :: $(ParticleID_dependencies) $(cmt_local_ParticleID_makefile) dirs ParticleIDdirs
	$(echo) "(constituents.make) Starting ParticleID"
	@if test -f $(cmt_local_ParticleID_makefile); then \
	  $(MAKE) -f $(cmt_local_ParticleID_makefile) ParticleID; \
	  fi
#	@$(MAKE) -f $(cmt_local_ParticleID_makefile) ParticleID
	$(echo) "(constituents.make) ParticleID done"

clean :: ParticleIDclean

ParticleIDclean :: $(ParticleIDclean_dependencies) ##$(cmt_local_ParticleID_makefile)
	$(echo) "(constituents.make) Starting ParticleIDclean"
	@-if test -f $(cmt_local_ParticleID_makefile); then \
	  $(MAKE) -f $(cmt_local_ParticleID_makefile) ParticleIDclean; \
	fi
	$(echo) "(constituents.make) ParticleIDclean done"
#	@-$(MAKE) -f $(cmt_local_ParticleID_makefile) ParticleIDclean

##	  /bin/rm -f $(cmt_local_ParticleID_makefile) $(bin)ParticleID_dependencies.make

install :: ParticleIDinstall

ParticleIDinstall :: $(ParticleID_dependencies) $(cmt_local_ParticleID_makefile)
	$(echo) "(constituents.make) Starting install ParticleID"
	@-$(MAKE) -f $(cmt_local_ParticleID_makefile) install
	$(echo) "(constituents.make) install ParticleID done"

uninstall : ParticleIDuninstall

$(foreach d,$(ParticleID_dependencies),$(eval $(d)uninstall_dependencies += ParticleIDuninstall))

ParticleIDuninstall : $(ParticleIDuninstall_dependencies) ##$(cmt_local_ParticleID_makefile)
	$(echo) "(constituents.make) Starting uninstall ParticleID"
	@if test -f $(cmt_local_ParticleID_makefile); then \
	  $(MAKE) -f $(cmt_local_ParticleID_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_ParticleID_makefile) uninstall
	$(echo) "(constituents.make) uninstall ParticleID done"

remove_library_links :: ParticleIDuninstall
...
#cmt_local_tagfile_config = $(ParticleID_tag)_config.make
cmt_local_tagfile_config = $(bin)$(ParticleID_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)ParticleID_configsetup.make
...
#cmt_local_tagfile_config = $(ParticleID_tag).make
cmt_local_tagfile_config = $(bin)$(ParticleID_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)ParticleIDsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(ParticleID_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(ParticleID_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)ParticleID_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(ParticleID_tag).make
cmt_local_tagfile_install_includes = $(bin)$(ParticleID_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)ParticleIDsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(ParticleID_tag)_make.make
cmt_local_tagfile_make = $(bin)$(ParticleID_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)ParticleID_makesetup.make
...
#cmt_local_tagfile_make = $(ParticleID_tag).make
cmt_local_tagfile_make = $(bin)$(ParticleID_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)ParticleIDsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(ParticleID_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(ParticleID_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)ParticleID_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(ParticleID_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(ParticleID_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)ParticleIDsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(ParticleID_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(ParticleID_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)ParticleID_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(ParticleID_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(ParticleID_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)ParticleIDsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(ParticleID_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(ParticleID_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)ParticleID_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(ParticleID_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(ParticleID_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)ParticleIDsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(ParticleID_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(ParticleID_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)ParticleID_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(ParticleID_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(ParticleID_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)ParticleIDsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(ParticleID_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(ParticleID_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)ParticleID_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(ParticleID_tag).make
cmt_local_tagfile_TestProject = $(bin)$(ParticleID_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)ParticleIDsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(ParticleID_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(ParticleID_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)ParticleID_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(ParticleID_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(ParticleID_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)ParticleIDsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(ParticleID_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(ParticleID_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)ParticleID_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(ParticleID_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(ParticleID_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)ParticleIDsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
